...
if not df_div.empty:
    ...
    # Using a Red-Blue diverging palette for better perception, as recommended.
    colors = {
        '1 - Strongly disagree': '#b2182b', # Dark Red
        '2 - Disagree': '#d6604d',         # Light Red
        '3 - Neutral': '#f0f0f0',         # Light Grey
        '4 - Agree': '#4393c3',           # Light Blue
        '5 - Strongly agree': '#2166ac'    # Dark Blue
    }
